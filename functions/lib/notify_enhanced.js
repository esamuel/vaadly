...
exports.notifyEnhanced = void 0;
exports.sendTargetedNotification = sendTargetedNotification;
const admin = __importStar(require("firebase-admin"));
const https_1 = require("firebase-functions/v2/https");
exports.notifyEnhanced = (0, https_1.onRequest)(async (req, res) => {
    try {
        ...
        const { buildingId, targets, title, body, emailHtml } = req.body;
...
async function sendTargetedNotification(buildingId, targets, title, body, emailHtml, createdBy) {
    try {
...
//# sourceMappingURL=notify_enhanced.js.map